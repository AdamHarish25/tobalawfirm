  ...
  return (
    <div className="min-h-screen bg-dark-white flex items-center justify-center">
      <Helmet>
        ...
        <meta
          name="description"
          content="Daftar sebagai admin Toba Lawfirm untuk mengelola konten dan layanan."
        />
      </Helmet>
      <Link
        to="/"
      ...
      <div className="bg-dark-gray p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleRegister}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-yellow-500 text-black font-bold py-3 rounded hover:bg-yellow-400 disabled:bg-gray-500"
          >
