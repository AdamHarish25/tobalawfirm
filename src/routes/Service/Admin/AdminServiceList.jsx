// src/components/AdminServiceList.jsx

import React from 'react';

// This component is very similar to AdminArticleList.
// It receives data and functions as props to stay "dumb" and reusable.
function AdminServiceList({ services, loading, onEdit, onDelete, onTogglePublish }) {

  if (loading) {
    // We can return null here because the parent AdminDash component already has a main loading state.
    // This avoids showing two "Loading..." messages.
    return null;
  }
